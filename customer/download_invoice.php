 ...
 * Generates a printable invoice for an order
 */
...
<head>
    ...
    <title>Invoice #<?php echo $invoiceNumber; ?> | AgriSphere</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="actions">
        ...
        <a href="order_detail.php?id=<?php echo $orderId; ?>" class="btn btn-secondary">
            Back to Order
        </a>
    </div>
    ...
    <div class="invoice">
        ...
        <div class="addresses">
            <div class="address-block">
                ...
                <p><?php echo nl2br(sanitize($customer['address'] ?? '')); ?></p>
                <p><?php echo sanitize($customer['phone'] ?? $customer['Phone']); ?></p>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>Thank you for shopping with AgriSphere!</strong></p>
